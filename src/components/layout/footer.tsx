...
const footerSections = [
  {
    ...
    links: [
      ...
      { label: "Free Assets", href: "/search?price=free" },
    ],
  },
  {
    title: "Categories",
    links: [
      { label: "System Prompts", href: "/search?category=system-prompts" },
      { label: "Cursor Rules", href: "/search?category=cursor-rules" },
      { label: "n8n Workflows", href: "/search?category=n8n-workflows" },
      { label: "Agent Blueprints", href: "/search?category=agent-blueprints" },
    ],
  },
  {
    title: "Creators",
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 py-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-text-tertiary leading-relaxed mb-5">
              The marketplace for production-ready AI configurations.
            </p>
            {/* Social links */}
            <div className="flex items-center gap-3">
              <a href="#" className="text-text-tertiary hover:text-text-secondary transition-colors" aria-label="Twitter / X">
              ...
              <a href="#" className="text-text-tertiary hover:text-text-secondary transition-colors" aria-label="Discord">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-6">
          <p className="text-xs text-text-tertiary font-mono">
            &copy; {new Date().getFullYear()} Ruleset AI
          </p>
